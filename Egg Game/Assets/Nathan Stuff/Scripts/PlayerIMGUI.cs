...
public class PlayerIMGUI : MonoBehaviour
{
    ...
    [SerializeField]private Sprite playerThreeSprite;

    private GameObject playerFour;
    [SerializeField]private Sprite playerFourSprite;

    private GameObject playerFive;
    [SerializeField]private Sprite playerFiveSprite;

    private GameObject playerSix;
    [SerializeField]private Sprite playerSixSprite;
    ...
    void Start()
    {
        if(GameObject.FindWithTag("Player1")){
            ...
            transform.GetChild(0).GetChild(0).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerOneSprite;
        }
        ...
        if(GameObject.FindWithTag("Player2")){
            ...
            transform.GetChild(0).GetChild(1).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerTwoSprite;
        }
        ...
        if(GameObject.FindWithTag("Player3")){
            ...
            transform.GetChild(0).GetChild(2).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerOneSprite;
        }
        ...
        if(GameObject.FindWithTag("Player4")){
            ...
            transform.GetChild(0).GetChild(3).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerOneSprite;
        }
        ...
        if(GameObject.FindWithTag("Player5")){
            ...
            transform.GetChild(0).GetChild(4).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerFiveSprite;
        }
        ...
        if(GameObject.FindWithTag("Player6")){
            ...
            transform.GetChild(0).GetChild(5).GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = playerSixSprite;
        }
    }
